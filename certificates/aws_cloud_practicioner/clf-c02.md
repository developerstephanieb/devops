...
- **AWS Identity and Access Management (IAM)**: Service used to manage permissions that control which AWS resources users can access.
...
- **Amazon DynamoDB Accelerator (DAX)**: Used to reduce response times from a DynamoDB table from single-digit milliseconds to microseconds.
